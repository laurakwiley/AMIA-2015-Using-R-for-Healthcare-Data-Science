...
<br>
<div class="warning">
**Warning:** Running str_detect() on NA returns NA.  If you don't know the data value, R can't know if it's a match!
</div>
...
iwpc_data %>% 
  ...
  datatable(colnames = c("CYP2C9","\\*1/\\*2","\\*1/\\*3","\\*2/\\*2","\\*2/\\*3","\\*3/\\*3","Unknown","N"))
```
